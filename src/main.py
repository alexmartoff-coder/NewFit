...
from src.handlers import start, trainer_onboarding, client_onboarding, catalog, profiles, booking, pro_booking, subscriptions, admin, schedule, favorites
...
async def main():
    ...
    dp.include_router(pro_booking.router)
